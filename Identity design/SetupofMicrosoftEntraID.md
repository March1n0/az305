...
Assigned appropriate group names.
Prepared groups for future role-based access assignments.
Intended Usage
...
Selected Users.
Chose New User.
Created internal member accounts.
...
Configuration Steps
Purchase Microsoft Entra ID Premium P1 licensing.
...
Step 6: Self-Service Password Reset (SSPR)
Business Requirement
